...
{\bf Exp.~2 (n=300):} Entailment was measured with the `inference' diagnostic: $p$ entails $q$ iff $q$ follows from $p$. %; under the `contradictoriness' diagnostic, $p$ entails $q$ iff $p$ {\em but not} $q$ is contradictory. 
