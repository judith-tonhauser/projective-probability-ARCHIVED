...
Factive predicates like {\em know} have long been singled out from the set of clause-embedding predicates because of the observation that the content of their clausal complement may project from under entailment-canceling operators, like negation (e.g.,  \citealt{karttunen71b,kiparsky-kiparsky71}). 
