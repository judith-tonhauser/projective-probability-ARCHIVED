...
Factive predicates have long been considered a special subset of the set of clause-embedding predicates because of the observation that the content of their clausal complement may project from under entailment-canceling operators like negation (e.g.,  \citealt{karttunen71b,kiparsky-kiparsky71}). 


Different types of analyses have been proposed to capture this empirical observation about these so-called factive predicates (e.g., \citealt{heim83,vds92,abrusan2011,abrusan2016,romoli2015,best-question}).

Recently, however, researchers have observed that the content of the 

However, given the observation that the content of the complement of some non-factive predicates, like {\em announce} and {\em ackno}, may also 
