...
\item Speaker commitment in embedded sentences is a gradient property that does not align with the factive / semi-factive / non-factive distinction that is typically assumed: \citealt{tbd-variability}, database, new experiment
...
\item Main clause asserted content: John is \{ definitely / probably / possibly \} going to be at the meeting.

\item Content of clausal complement: experiment {\em ...but he's not}: contradictoriness experiment
...
\includegraphics[width=.45\paperwidth]{../results/3-projectivity/graphs/mean-projectivity-by-mean-contradictoriness}

\caption{Mean projectivity rating by mean contradictoriness rating, by predicate}
\label{f-veridicality-predicate}
\end{figure}

compare to Rawlins \& White

\item \citealt{anand-hacquard2014}: veridical, factive, neither (not empirically supported)


\item Theoretical implications: Conventionalist theories of presuppositions that assume that presuppositions are speaker commitments in unembedded sentences cannot be maintained
