...
\noindent
{\bf Outline of MIT talk}

\begin{itemize}[leftmargin=5ex,topsep=0pt,itemsep=-2pt]

\item Theoretical work distinguishes how speaker commitment to a proposition p arises:

\begin{itemize}[leftmargin=5ex,topsep=0pt,itemsep=-2pt]

\item Asserted content: John is not going to be at the meeting.

\item Entailments: Mary is right that John is not going to be at the meeting.

\item Presuppositions: Mary knows that John is not going to be at the meeting.

\item Conventional implicatures: John, who is not going to be at the meeting, just called me.

\item Conversational implicatures: (Is John going to be at the meeting?) John is at home. (Implicature: John is not going to be at the meeting)

\end{itemize}

\item How does speaker commitment to the content of the clausal complement of an attitude predicate arise? Current theoretical picture, where ps and entailment are distinguished by embedding under entailment-canceling operators:

\begin{itemize}[leftmargin=5ex,topsep=0pt,itemsep=-2pt]

\item Presupposition: {\em know} (commitment typically in unembedded and embedded)

\item Entailment: {\em is right} (commitment typically in unembedded, not in embedded)

\item Something else: {\em say, announce} (commitment neither typically in unembedded nor in embedded, though possible)

\begin{tabular}{l|cc}
& commitment in unembedded & commitment in embedded \\ \hline
ps & yes & yes \\
entailment & yes & no \\
other & no & no \\
...
\item {\bf Speaker commitment is assumed to be lexically coded.}

\end{itemize}

\item Problems with this picture:

\begin{itemize}

\item Speaker commitment in unembedded sentences is a gradient property: 

\begin{itemize}

\item Asserted content: John is \{ definitely / probably / possibly \} going to be at the meeting.

\item Content of clausal complement: experiment {\em ...but he's not}

\end{itemize}

\item Speaker commitment in embedded sentences is a gradient property: \citealt{tbd-variability}
